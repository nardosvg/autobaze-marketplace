    ...
    >
      ...
      <Dropdown show={open}>
        <div className="lg:w-[460px] shadow-lg">
          <h3 className="uppercase heading-md border-b p-4">Carrinho</h3>
          <div className="p-4">
            {Boolean(cartItemsCount) ? (
              <div>
                ...
                <div className="pt-4">
                  <div className="text-secondary flex justify-between items-center">
                    Itens <p className="label-md text-primary">{items}</p>
                  </div>
                  <div className="text-secondary flex justify-between items-center">
                    Entrega <p className="label-md text-primary">{delivery}</p>
                  </div>
                  <div className="text-secondary flex justify-between items-center">
                  ...
                  <LocalizedClientLink href="/cart">
                    <Button className="w-full mt-4 py-3">Ir pro carrinho</Button>
                  </LocalizedClientLink>
                </div>
              </div>
            ) : (
              <div className="px-8">
                ...
                <LocalizedClientLink href="/categories">
                  <Button className="w-full py-3">Ver ofertas</Button>
                </LocalizedClientLink>
              </div>
            )}
          </div>
